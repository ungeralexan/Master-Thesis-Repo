...
source("/Users/alexung/Desktop/master_thesis/code/vietnam/run_through.R")   # runs everything, populates environment
```
...
```{r}
# ==============================================================================
# BLOCK H — DOUBLEML WALD-AIPW LEARNER ROBUSTNESS
# Requires: DoubleML objects iivm_lm, iivm_rf, iivm_xgb
# ==============================================================================

cat(strrep("=", 70), "\n")
cat("BLOCK H — DOUBLEML WALD-AIPW LEARNER ROBUSTNESS\n")
cat(strrep("=", 70), "\n\n")

cat("Point estimates:\n")
cat(sprintf("  %-35s  %10s\n", "Estimator", "Estimate"))
cat(strrep("-", 50), "\n")
cat(sprintf("  %-35s  %10.4f\n",
            "Wald-AIPW DoubleML linear/logit", as.numeric(iivm_lm$coef)))
cat(sprintf("  %-35s  %10.4f\n",
            "Wald-AIPW DoubleML ranger", as.numeric(iivm_rf$coef)))
cat(sprintf("  %-35s  %10.4f\n",
            "Wald-AIPW DoubleML XGBoost", as.numeric(iivm_xgb$coef)))
cat("\n")
...
```{r}
# ==============================================================================
# BLOCK I — OPTIONAL LOVE PLOTS: DOUBLEML WALD-AIPW LEARNERS
# ==============================================================================

cat(strrep("=", 70), "\n")
cat("BLOCK I — OPTIONAL LOVE PLOTS: DOUBLEML WALD-AIPW LEARNERS\n")
cat(strrep("=", 70), "\n\n")
...
lp_lm  <- make_love_dml("Wald-AIPW DoubleML linear/logit", w_waipw_lm)
lp_rf  <- make_love_dml("Wald-AIPW DoubleML ranger",       w_waipw_rf)
lp_xgb <- make_love_dml("Wald-AIPW DoubleML XGBoost",      w_waipw_xgb)

grid.arrange(lp_lm, lp_rf, lp_xgb, nrow = 1)
```
